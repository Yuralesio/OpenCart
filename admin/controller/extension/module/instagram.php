...
class ControllerExtensionModuleInstagram extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['userid'])) {
			$data['error_user'] = $this->error['userid'];
		} else {
			$data['error_user'] = '';
		}
		...
		if (isset($this->request->post['site_key'])) {
			$data['site_key'] = $this->request->post['site_key'];
		} elseif (!empty($module_info)) {
			$data['site_key'] = $module_info['site_key'];
		} else {
			$data['site_key'] = '';
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['user_id']) {
			$this->error['userid'] = $this->language->get('error_user');
		}

		if (!$this->request->post['site_key']) {
